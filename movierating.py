...
# Load the dataset
data = pd.read_csv("C:\\Users\\pooja\\Downloads\\IMDb Movies India.csv", encoding='latin1')
...
print(f"R-squared Value (Accuracy): {accuracy_percentage:.2f}%")
